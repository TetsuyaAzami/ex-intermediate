...
@Repository
public class ColotheRepository {
	...
	public List<Clothe> searchByColorAndGender(String color, Integer gender) {
		String sql =
				"SELECT id,genre,size,price FROM clothes WHERE color = :color AND gender = :gender;";
		SqlParameterSource param =
				new MapSqlParameterSource().addValue("color", color).addValue("gender", gender);
